...
describe('uploadDB', () => {
    ...
    describe('getUploadDataById', () => {
        ...
        it('returns null if the upload does not exist', () => {
    ...
    describe('updateUploadRecordById', () => {
        ...
        it('throws an error if updateId not in DB', () => {
            expect(() => updateUploadRecordById('noId', true)).toThrowError(new Error('No upload with upload id: noId'));
        })
    })
    ...
    describe('getProgressById', () => {
        ...
        it('returns null if no record exists for id', () => {
            expect(getProgressById('noId')).toBe(null)
        })
    })
})